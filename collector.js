...
},{"./collector/index":302}],301:[function(require,module,exports){
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}Object.defineProperty(exports,"__esModule",{value:!0}),exports["default"]=function(e){function t(t,i){a.value=t,r.textContent=i,(0,_setStyles2["default"])(d,{opacity:.5*t+.5}),e.title=Math.round(100*t)+"% "+i}var i=arguments.length<=1||void 0===arguments[1]?!1:arguments[1],n=void 0,o=void 0,a=void 0,r=void 0,d=void 0;return Promise.resolve().then(function(){(0,_setStyles2["default"])(e.body,{overflow:"hidden"}),(0,_setStyles2["default"])(e.documentElement,{overflow:"hidden"}),n=e.createElement("iframe"),n.src=e.location.href.split("#")[0]+(e.location.search?"&":"?")+e.location.hash,(0,_setStyles2["default"])(n,{position:"absolute",top:0,left:0,opacity:0,"z-index":2147483647,width:"100vw","max-width":"none","min-width":0,height:"100vh","max-height":"none","min-height":0,border:0});var i=new Promise(function(e,t){function i(){n.contentWindow.jQuery&&0!==n.contentWindow.jQuery.active?setTimeout(i,10):e()}n.addEventListener("load",function(){try{n.contentWindow.document}catch(e){return void t(new Error("Failed loading page into iframe."))}setTimeout(i)})});return e.body.appendChild(n),d=e.createElement("div"),e.body.appendChild(d),(0,_setStyles2["default"])(d,{position:"fixed",top:0,left:0,right:0,bottom:0,"background-color":"rgba(255, 255, 255, 0)",opacity:.5,"z-index":2147483647,transition:"background-color 1s linear"}),d.offsetWidth,(0,_setStyles2["default"])(d,{"background-color":"#fff"}),a=e.createElement("progress"),(0,_setStyles2["default"])(a,{position:"fixed",top:"50%",left:"50%",transform:"translate(-50%, -50%)",width:"33%","z-index":2147483647}),e.body.appendChild(a),r=e.createElement("div"),(0,_setStyles2["default"])(r,{position:"fixed",top:"50%",left:"0",transform:"translate(0, 50px)",width:"100%","text-align":"center","font-size":"16px",color:"black","white-space":"pre-line","text-shadow":"0 0 2px white, 0 0 2px white, 0 0 2px white, 0 0 2px white","z-index":2147483647}),e.body.appendChild(r),t(.05,"Loading page into frame..."),i}).then(function(){return t(.1,"Resizing"),o=(0,_find2["default"])(n.contentWindow.document).map(_readData2["default"]).map(_readMarkup2["default"]),(0,_readDimensions2["default"])(n,o,function(e,i){t(.1+.8*e,"Resizing to "+i)})}).then(function(){return t(.9,"Reading image"),(0,_readImages2["default"])(n.contentWindow.document,o,function(e,i,n){n&&t(.9+.1*e,"Reading image "+Math.round(e*i)+" of "+i+"\n"+n.url)})}).then(function(){return t(1,"Done"),i||o.forEach(function(e){delete e.dom}),o})},require("babel-polyfill");var _find=require("./find"),_find2=_interopRequireDefault(_find),_readData=require("./readData"),_readData2=_interopRequireDefault(_readData),_readMarkup=require("./readMarkup"),_readMarkup2=_interopRequireDefault(_readMarkup),_readDimensions=require("./readDimensions"),_readDimensions2=_interopRequireDefault(_readDimensions),_readImages=require("./readImages"),_readImages2=_interopRequireDefault(_readImages),_setStyles=require("../util/setStyles"),_setStyles2=_interopRequireDefault(_setStyles);

},{"../util/setStyles":307,"./find":301,"./readData":303,"./readDimensions":304,"./readImages":305,"./readMarkup":306,"babel-polyfill":1}],303:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function readData(e){var r=e.dom.img;return e.data={img:r&&{src:r.getAttribute("src"),srcset:parseSrcset(r.getAttribute("srcset")),sizes:parseSizes(r.getAttribute("sizes"))},sources:e.dom.sources.map(function(e){return{srcset:parseSrcset(e.getAttribute("srcset")),sizes:parseSizes(e.getAttribute("sizes")),media:parseMedia(e.getAttribute("media")),type:e.getAttribute("type")||void 0}})},e}function parseSrcset(e){if(!e)return[];var r=[];return e.replace(/,*(\S*?[^\s,])(?:\s,|,+\s|,?$|\s([^,]+)(?:,|$))/g,function(e,t,s){r.push({src:t,descriptor:s&&s.trim()})}),r}function parseSizes(e){return e?e.split(",").map(function(e){e=e.trim();var r=void 0;return e=e.replace(/^\(.+?\)\s+/,function(e){return r=parseMedia(e.trim()),""}),{size:e,media:r}}):[]}function parseMedia(e){if(e)try{return(0,_cssMqParser2["default"])(e.toLowerCase().replace(/\s+/g," "))}catch(r){return e}}Object.defineProperty(exports,"__esModule",{value:!0}),exports["default"]=readData;var _cssMqParser=require("css-mq-parser"),_cssMqParser2=_interopRequireDefault(_cssMqParser);

},{"css-mq-parser":298}],304:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function readDimensions(e,t,i){return new Promise(function(n){function d(){var o=arguments.length<=0||void 0===arguments[0]?Date.now():arguments[0];i((s-minWidth)/(maxWidth-minWidth),s);var m=s;if(r&&(s-minWidth)%(2*stepSize)===0&&(m/=2),a&&imageWidth(a)!==m&&!p)return s===minWidth&&Date.now()-h>5e3&&(p=!0),(0,_setStyles2["default"])(e,{height:"calc(100vh - 1px)"}),e.offsetHeight,(0,_setStyles2["default"])(e,{height:"100vh"}),void setTimeout(d,0);var l=t.reduce(function(e,t){return e&&(!t.dom.img||t.dom.img.complete)},!0);return l?(addDimensions(t,s),s+=stepSize,s>maxWidth?(i(1,maxWidth),void n()):((0,_setStyles2["default"])(e,{width:s+"px"}),Date.now()-o>1e3/30?void setTimeout(d,0):void d(o))):void setTimeout(d,0)}var o=e.contentWindow.document,s=minWidth;(0,_setStyles2["default"])(e,{width:s+"px"}),(0,_setStyles2["default"])(o.documentElement,{overflow:"hidden"}),(0,_setStyles2["default"])(o.body,{overflow:"hidden"});var a=o.createElement("img");"sizes"in a?(a.srcset="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7 1w",a.sizes="100vw",(0,_setStyles2["default"])(a,{position:"absolute",top:0,left:0,display:"block",width:"auto","max-width":"none","min-width":0,height:"auto","max-height":"none","min-height":0,border:0,padding:0}),o.body.appendChild(a)):a=void 0;var r=o.createElement("source"),m=o.createElement("picture");if("sizes"in r){r.srcset=a.srcset,r.sizes="50vw";for(var l=[],u=minWidth;maxWidth>=u;u+=2*stepSize)l.push(u);r.media=l.map(function(e){return"(width:"+e+"px)"}).join(","),m.appendChild(r),m.appendChild(a),o.body.appendChild(m)}else r=void 0,m=void 0;var h=Date.now(),p=!1;d()})}function addDimensions(e,t){e.forEach(function(e){return addDimension(e,t)})}function addDimension(e,t){e.dimensions=e.dimensions||{},e.dom.img&&(e.dimensions[t]=imageWidth(e.dom.img))}function imageWidth(e){var t=getComputedStyle(e);return e.clientWidth-parseFloat(t.paddingLeft)-parseFloat(t.paddingRight)}Object.defineProperty(exports,"__esModule",{value:!0}),exports["default"]=readDimensions;var _setStyles=require("../util/setStyles"),_setStyles2=_interopRequireDefault(_setStyles),minWidth=300,maxWidth=3e3,stepSize=10;

},{"../util/setStyles":307}],305:[function(require,module,exports){
"use strict";function readImages(e,t,r){return new Promise(function(a){function n(){var e=arguments.length<=0||void 0===arguments[0]?Date.now():arguments[0],t=void 0;return Object.keys(i).forEach(function(e){i[e].element&&i[e].element.complete&&(t=i[e])}),r(Object.keys(i).reduce(function(e,t){return e+(i[t].element?0:1)},0)/(Object.keys(i).length||1),Object.keys(i).length,t),t&&(readImage(t),null===t.hash&&"crossorigin.me"!==t.element.src.split("/")[2]?(t.element=new Image,t.element.crossOrigin="anonymous",t.element.src="https://crossorigin.me/"+t.url):delete t.element),Object.keys(i).reduce(function(e,t){return e&&!i[t].element},!0)?(r(1,Object.keys(i).length),void c()):t?Date.now()-e>1e3/30?void setTimeout(n,0):void n(e):void setTimeout(n,16)}function c(){t.forEach(function(e){e.images={},e.data.img&&e.data.img.src&&(e.images[e.data.img.src]=i[e.data.img.src]),e.data.img&&e.data.img.srcset&&e.data.img.srcset.forEach(function(t){var r=t.src;e.images[r]=i[r]}),e.data.sources.forEach(function(t){var r=t.srcset;r.forEach(function(t){var r=t.src;e.images[r]=i[r]})})}),a()}var s=[];t.forEach(function(e){var t=e.data;t.img&&t.img.src&&s.push(t.img.src),t.img&&t.img.srcset&&t.img.srcset.forEach(function(e){var t=e.src;s.push(t)}),t.sources.forEach(function(e){var t=e.srcset;t.forEach(function(e){var t=e.src;s.push(t)})})}),s=s.filter(function(e,t){return s.indexOf(e)===t});var i={};s.forEach(function(t){var r={url:resolveUrl(e,t)},a=new Image;a.src=r.url,r.element=a,i[t]=r}),n()})}function resolveUrl(e,t){var r=e.createElement("a");return r.href=t,r.href+""}function readImage(e){e.size=e.size||{width:e.element.naturalWidth,height:e.element.naturalHeight},e.type=e.type||e.url.split("#")[0].split("?")[0].split(".").pop().toLowerCase(),"jpg"===e.type&&(e.type="jpeg"),e.hash=e.hash||getImageHash(e.element)}function getImageHash(e){var t=8,r=16,a=void 0;try{var n=!0;a=Array.from(stepDownResize(e,t).getImageData(0,0,t,t).data).reduce(function(e,t,a,c){if(t&&(n=!1),(a+1)%4){var s=c[a+(4-(a+1)%4)]/255;t*=s,a%4===a%8&&(t+=255*(1-s)),e+=Math.round(t*((r-1)/255)).toString(r)}return e},""),n&&(a=void 0)}catch(c){18===c.code&&(a=null)}return a}function stepDownResize(e,t){for(var r=Math.max(e.naturalWidth||0,e.naturalHeight||0,t),a=t;r>2*a;)a*=2;var n=createCanvasCtx(a),c=createCanvasCtx(a);for(n.drawImage(e,0,0,a,a),n.getImageData(0,0,1,1);a>t;)c.clearRect(0,0,a,a),c.drawImage(n.canvas,0,0,a,a,0,0,a,a),n.clearRect(0,0,a/2,a/2),n.drawImage(c.canvas,0,0,a,a,0,0,a/2,a/2),a/=2;return n}function createCanvasCtx(e){var t=document.createElement("canvas");return t.width=t.height=e,t.getContext("2d")}Object.defineProperty(exports,"__esModule",{value:!0}),exports["default"]=readImages;
...
"use strict";function setStyles(e,t){var s=arguments.length<=2||void 0===arguments[2]?!0:arguments[2];Object.keys(t).forEach(function(o){e.style.setProperty(o,t[o],s?"important":"")})}Object.defineProperty(exports,"__esModule",{value:!0}),exports["default"]=setStyles;
