...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}var _index=require("./collector/index"),_index2=_interopRequireDefault(_index),script=document.getElementById("respimagelint-script"),scriptHost=script.src.split("/",3).join("/");(0,_index2["default"])(document).then(function(e){return e={href:document.location.href,data:e},new Promise(function(t){window.addEventListener("message",function(n){"respImageLintStoreReady"===n.data&&n.source.postMessage(JSON.stringify(e),"*"),"respImageLintStoreDone"===n.data&&t()});var n=document.createElement("iframe");n.src=scriptHost+"/dist/store.html",document.body.appendChild(n)})}).then(function(){document.location.href=scriptHost+"/dist/linter.html"})["catch"](function(e){alert(e),document.location.reload()});
