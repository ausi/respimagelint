...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function readDimensions(e,t,i){return new Promise(function(n){function d(){var m=arguments.length<=0||void 0===arguments[0]?Date.now():arguments[0];if(i((o-minWidth)/(maxWidth-minWidth),o),s&&imageWidth(s)!==o)return o===minWidth&&Date.now()-a>5e3&&(s=void 0),void setTimeout(d,0);var u=t.reduce(function(e,t){return e&&(!t.dom.img||t.dom.img.complete)},!0);return u?(addDimensions(t,o),o+=stepSize,o>maxWidth?(i(1,maxWidth),void n()):((0,_setStyles2["default"])(e,{width:o+"px"}),Date.now()-m>1e3/30?void setTimeout(d,0):void d(m))):void setTimeout(d,0)}var o=minWidth;(0,_setStyles2["default"])(e,{width:o+"px"}),(0,_setStyles2["default"])(e.contentWindow.document.documentElement,{overflow:"hidden"}),(0,_setStyles2["default"])(e.contentWindow.document.body,{overflow:"hidden"});var s=e.contentWindow.document.createElement("img");"sizes"in s?(s.srcset="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7 1w",s.sizes="100vw",(0,_setStyles2["default"])(s,{position:"absolute",top:0,left:0,width:"auto","max-width":"none","min-width":0,height:"auto","max-height":"none","min-height":0,border:0,padding:0}),e.contentWindow.document.body.appendChild(s)):s=void 0;var a=Date.now();d()})}function addDimensions(e,t){e.forEach(function(e){return addDimension(e,t)})}function addDimension(e,t){e.dimensions=e.dimensions||{},e.dom.img&&(e.dimensions[t]=imageWidth(e.dom.img))}function imageWidth(e){var t=getComputedStyle(e);return e.clientWidth-parseFloat(t.paddingLeft)-parseFloat(t.paddingRight)}Object.defineProperty(exports,"__esModule",{value:!0}),exports["default"]=readDimensions;var _setStyles=require("../util/setStyles"),_setStyles2=_interopRequireDefault(_setStyles),minWidth=300,maxWidth=3e3,stepSize=10;
